...
# --------------------------------------------------------
# 1) Read the existing VTP file
# --------------------------------------------------------
filename = "/workspace/my_examples/example_antenna/outputs/time/constraints/wave_constraint.vtp"
...
# --------------------------------------------------------
# 2) Interpolate onto a regular 2D grid
# --------------------------------------------------------
...
# --------------------------------------------------------
# 4) Optional – Save structured field as before
# --------------------------------------------------------
...
multiblock = pv.MultiBlock([grid, antenna])

multiblock.save("/workspace/my_examples/example_antenna/outputs/time/constraints/wave_field_structured_antenna.vtm")
grid.save("/workspace/my_examples/example_antenna/outputs/time/constraints/wave_field_structured.vtk")

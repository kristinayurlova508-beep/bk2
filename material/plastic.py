...
print("=== plastic.py START ===", flush=True)
import sys
...
def run(cfg) -> None:
    ...
    absorption_air = 0.1
    # Druhé prostredie: plastic (absorpcia podľa materiálu)
    absorption_mat = 0.2

    amplitude = 1.0
    lambda_val = 0.3

    # Vertikálna hranica medzi prostredím – x < boundary_x: vzduch, x >= boundary_x: plastic
    boundary_x = 1.5

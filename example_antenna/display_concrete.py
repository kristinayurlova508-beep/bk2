...
filename = "/workspace/my_examples/example_antenna/outputs/concrete/constraints/wave_constraint.vtp"
...
pv.MultiBlock([grid]).save(
    "/workspace/my_examples/example_antenna/outputs/concrete/constraints/wave_field_structured.vtm"
)
